...
func GetFoods() gin.HandlerFunc{
	return func (c *gin.Context)  {
		...
		projectStage := bson.D{{"$project",bson.D{{"_id",0},{"total_count",1},{"food_itmes",bson.D{{"$slice",[]interface{}{"$data",startIndex,recordPerPage}}}}}}}
		...
		defer cancel()
		if err != nil{
			c.JSON(http.StatusInternalServerError,gin.H{"error":"error occured while listening to"})
			return
		}
		...
		c.JSON(http.StatusOK,allModel[0])
...
func tobefixed(num float64,precision int) float64 {
